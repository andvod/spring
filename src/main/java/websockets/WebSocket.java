...
public class WebSocket {
	...
	static Logger log = Logger.getLogger(WebSocket.class.getName());
	...
	public void onMessage(String message, Session session) throws IOException,
		...
		wsSession.getBasicRemote().sendText(String.format("Mr %s: %s \n", userName, message));
	}
